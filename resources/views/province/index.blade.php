              ...
              <div class="col-xs-12">
                  <div class="box">
                      <div class="box-header">
                          <h3 class="box-title">استان</h3>
                          <a class="btn btn-primary pull-left" href="/statistics_province/create">ثبت استان</a>
                      </div><!-- /.box-header -->
                      <div class="box-body">
                          <table id="example2" class="table table-bordered table-hover table-striped" data-page-length='20'>
                              ...
                              @foreach($provinces as $i=>$province)
                                <tr>
                                  ...
                                  <td>{{ $province->name }}</td>
                                  <td>
                                    <a class="btn btn-success" href="/statistics_province/edit/{{ $province->id }}">
                                    ویرایش
                                    </a>
                                    <a class="btn btn-danger btn-delete" href="/statistics_province/delete/{{ $province->id }}">
                                    حذف
                                    </a>
                                  </td>
                                </tr>
