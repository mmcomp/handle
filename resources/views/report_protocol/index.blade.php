                        ...
                        <table id="example2" class="table table-condensed table-bordered table-hover table-striped table-responsive" data-page-length='20'>
                            ...
                            @foreach($protocols as $i=>$protocol)
                              <tr>
                                ...
                                <td>{{ ($protocol->service)?$protocol->service->name:'' }}</td>
                                <td>{{ ($protocol->service_desc)?$protocol->service_desc->name:'' }}</td>
                                <td>{{ ($protocol->giving_unit)?$protocol->giving_unit->name:'' }}</td>
                                <td>{{ ($protocol->contractor)?$protocol->contractor->name:'' }}</td>
                                <td>{{ ($protocol->winner_select_way)?$protocol->winner_select_way->name:'' }}</td>
                                <td>{{ $protocol->start_date }}</td>
                                <td>{{ $protocol->end_date }}</td>
                                <td>{{ 0 }}</td>
                                <td>{{ 0 }}</td>
                                <td>{{ 0 }}</td>
                                <td>{{ 0 }}</td>
