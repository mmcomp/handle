              ...
              <div class="col-xs-12">
                  <div class="box">
                      <div class="box-header">
                          ...
                          <a class="btn btn-primary pull-left" href="/statistics_city/create">ثبت شهر</a>
                      </div><!-- /.box-header -->
                      <div class="box-body">
                          <table id="example2" class="table table-bordered table-hover table-striped" data-page-length='20'>
                              ...
                              @foreach($cities as $i=>$city)
                                <tr>
                                  ...
                                  <td>
                                    <a class="btn btn-success" href="/statistics_city/edit/{{ $city->id }}">
                                    ویرایش
                                    </a>
                                    <a class="btn btn-danger btn-delete" href="/statistics_city/delete/{{ $city->id }}">
                                    حذف
                                    </a>
                                  </td>
                                </tr>
