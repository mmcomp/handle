              ...
              <div class="col-xs-12">
                  <div class="box">
                      <div class="box-header">
                          <h3 class="box-title">{{ $sample->desc }}</h3>
                          <a class="btn btn-primary pull-left" href="/{{ $path }}/create">ثبت {{ $sample->desc }}</a>
                      </div><!-- /.box-header -->
                      <div class="box-body">
                          <table id="example2" class="table table-bordered table-hover table-striped" data-page-length='20'>
                              ...
                              @foreach($statics as $i=>$static)
                                <tr>
                                  ...
                                  <td>{{ $static->name }}</td>
                                  <td>
                                    <a class="btn btn-success" href="/{{ $path }}/edit/{{ $static->id }}">
                                    ویرایش
                                    </a>
                                    <a class="btn btn-danger btn-delete" href="/{{ $path }}/delete/{{ $static->id }}">
                                    حذف
                                    </a>
                                  </td>
                                </tr>
