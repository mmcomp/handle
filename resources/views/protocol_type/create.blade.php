                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="description" name="description" placeholder="توضیحات" value="{{ ($protocol_type && $protocol_type->description)?$protocol_type->description:'' }}">
                                    </div>                              
                                </div>
                                <div class="col-xs-12">
